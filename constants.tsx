...
export const ASSETS = {
  LOGO: (
    <div className="relative w-12 h-12 flex items-center justify-center">
      <div className="absolute inset-0 bg-gradient-to-tr from-orange-500 via-fuchsia-500 to-blue-500 rounded-full blur-md opacity-40 animate-pulse"></div>
  ...
  CORE_ROBOT: (
    <div className="relative w-16 h-16 flex items-center justify-center">
      <div className="absolute top-0 left-1/4 right-1/4 h-1 bg-champagne-gold/40 rounded-full"></div>
      <div className="absolute -top-1 left-1/4 w-2 h-2 bg-champagne-gold rotate-45"></div>
      <div className="absolute -top-1 right-1/4 w-2 h-2 bg-champagne-gold rotate-45"></div>
      <svg className="w-12 h-12 text-platinum-cyan filter drop-shadow-[0_0_8px_rgba(0,229,255,0.6)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  PRIVACY_LOCK: (
    <div className="flex items-center gap-1">
      ...
      <svg className="w-8 h-8 text-blue-500 filter drop-shadow-[0_0_5px_rgba(59,130,246,0.5)]" viewBox="0 0 24 24" fill="currentColor">
